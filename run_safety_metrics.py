...
# No config file; supply everything via flags:
  python run_safety_metrics.py \\
      ...
      --output-dir output/safety_metrics/run_01 \\
...
----------------
  python run_safety_metrics.py --config configs/safety_default.yaml \\
      --output-dir output/safety_metrics/run_a
  python run_safety_metrics.py --config configs/safety_near_strict.yaml \\
      --output-dir output/safety_metrics/run_b
  python run_safety_metrics.py --compare \\
      output/safety_metrics/run_a/summary.json \\
      output/safety_metrics/run_b/summary.json
"""
