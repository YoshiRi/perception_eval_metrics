...
# Override threshold:
  python run_rematch.py --config configs/rematch_default.yaml --threshold 1.0 --label tight_1m

# No config file:
  python run_rematch.py \\
      --csv path/to/current.csv \\
      --output-dir output/rematch/run_01 \\
      --threshold 2.0
...
def main() -> None:
    ...
    print(
        ...
        f"  python run_safety_metrics.py --config configs/safety_default.yaml \\\n"
